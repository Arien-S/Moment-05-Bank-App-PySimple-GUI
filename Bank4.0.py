...
def Transactions_Konto_1():                     #Gör en Funktion för konto 1 (kommer kommentera endast 
    ...
    while True:     
        ...
        if event == sg.WIN_CLOSED:   #Stänger programmet om man klickar på exit eller windows krysset
            break
        ...
        if event == "InConfirm2":                                               #När man klickar ta ut till konto 2  
            ...
            if BalanceAmount1 < int(values["InAmount"]):                        #kollar om värdet angivet är mer än vad kontot som ska dras från har
                sg.popup("Du har inte tillräckligt med pengar på konto 1")      #om detta är sant så får man en popup och tas tilbaka tillfunctionen
                Transactions_Konto_1()

            else:                                                               #annnars kör den som vanligt                  
                
                try:                                                            #OBS! På varje if sats sär jag öppnar filer eller tar emot inputs gör jag en try except på Value Error så att man inte kan skriva in bokstäver        
                    value = int(values["InAmount"]) + BalanceAmount2                #adderar kontots och det inskrivnas tal till en variabel                 
                except ValueError:
        ...
        if event == "OutConfirm2":                                              #och tas bort från kontot som man väljers saldo{
            if BalanceAmount2 < int(values["OutAmount"]):
                sg.popup("Du har inte tillräckligt med pengar på konto 2")
                Transactions_Konto_1()
        ...
        if event == "InConfirm3":                                               #samma sak sker här som överföringen mellan konto 1 och konto 2 fast nu byts konto 2 ut mot 3{
            ...
            if BalanceAmount1 < int(values["InAmount"]):
                sg.popup("Du har inte tillräckligt med pengar på konto 1")
                Transactions_Konto_1()
        ...
        if event == "OutConfirm3":
            ...
            if BalanceAmount3 < int(values["OutAmount"]):
                sg.popup("Du har inte tillräckligt med pengar på konto 3")
                Transactions_Konto_1()
...
def Transactions_Konto_2():
    ...
    while True:
        ...
        if event == "InConfirm1":
            ...
            if BalanceAmount2 < int(values["InAmount"]):
                sg.popup("Du har inte tillräckligt med pengar på konto 2")
                Transactions_Konto_2()
        ...
        if event == "OutConfirm1":
            ...
            if BalanceAmount1 < int(values["OutAmount"]):
                sg.popup("Du har inte tillräckligt med pengar på konto 1")
                Transactions_Konto_2()
...
def Transactions_Konto_3():
    ...
    while True:
        ...
        if event == "InConfirm1":
            ...
            if BalanceAmount3 < int(values["InAmount"]):
                sg.popup("Du har inte tillräckligt med pengar på konto 3")
                Transactions_Konto_2()
